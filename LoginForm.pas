   ...
   try
    ...
    begin
      ...
      BanReason := ADOQuery.FieldByName('BanReason').AsString;
        ...
        0:
          begin
            ShowMessage('Ваш аккаунт не был активирован. Пожалуйста, обратитесь к системному администратору.');
            ModalResult := mrCancel;
          end;
        2:
          begin
            ShowMessage('Ваш аккаунт заблокирован. Причина блокировки: ' + BanReason);
            ModalResult := mrCancel;
          end;
        1:
          begin
            ShowMessage('Успешный вход под именем ' + Username);
