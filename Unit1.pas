...
begin
  ...
  begin
    ShowMessage('Невозможно открыть меню редактирования данных в режиме гостя.');
    Exit;
  end;
